    ...
    try {
      ...
      if (user) {
        await updateDoc(doc(db, 'users', user.uid), {
          ...
          typeSelectedAt: serverTimestamp(),
    ...
    <div className="min-h-screen bg-[#050505] p-6 flex flex-col">
      ...
      <div className="flex-1 space-y-4">
        ...
        {selected === UserType.RECRUITER && (
          <div className="bg-gradient-to-br from-[#102419] to-[#0A0A0A] border border-[#19DB8A]/45 rounded-2xl p-4 shadow-[0_0_24px_rgba(25,219,138,0.12)]">
            <h3 className="mb-3 inline-flex items-center gap-2 rounded-full border border-[#19DB8A]/45 bg-[#19DB8A]/12 px-3 py-1 text-sm font-bold tracking-wide text-[#19DB8A]">
              Sous-catégorie recruteur
            </h3>
