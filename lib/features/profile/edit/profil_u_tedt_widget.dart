...
/// cree une page de profil standars pour tout les utilisateurs de cette
/// application avec un design moderne et futuriste
                                            ...
                                            if (selectedMedia != null &&
                                              ...
                                              try {
                                                ...
                                                ScaffoldMessenger.of(context)
                                                    .hideCurrentSnackBar();
                                                _model.isDataUploading_uploadDataDlp =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadDataDlp =
                                                      selectedUploadedFiles
                                                          .first;
                                                  _model.uploadedFileUrl_uploadDataDlp =
                                                      downloadUrls.first;
                                                });
                                                showUploadMessage(
                                                    context, 'Success!');
                                            ...
                                            children: [
                                              AuthUserStreamWidget(
                                                builder: (context) => SizedBox(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .textFieldnomTextController,
                                                    focusNode: _model
                                                        .textFieldnomFocusNode,
                                                    autofocus: false,
                                                    obscureText: false,
                                            ...
                                            children: [
                                              AuthUserStreamWidget(
                                                builder: (context) => SizedBox(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .textFieldpaysTextController,
                                                    focusNode: _model
                                                        .textFieldpaysFocusNode,
                                                    autofocus: false,
                                                    obscureText: false,
                                                    decoration: InputDecoration(
                                                      isDense: true,
                                                    ...
                                                    cursorColor:
                                                        FlutterFlowTheme.of(
                                                            ...
                                                            .primaryText,
                                                    validator: _model
                                                        .textFieldpaysTextControllerValidator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
