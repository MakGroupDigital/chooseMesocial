...
/// sur base de cette application cree une page avec un choisetype disant à
/// l'utilisateur  choisir la categorie de son profil ; jouere ou athelete ,
/// recruteur ou managere , club ou equipe et journaliste ou presse enfin de
/// finir le procesuse de creation de compte utilise un dropdown
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              24.0, 16.0, 24.0, 32.0),
                          child: Text(
                            'Sélectionnez la catégorie qui correspond le mieux à votre rôle dans le monde du sport',
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FlutterFlowDropDown<String>(
                                    ...
                                    hintText: 'Sélectionnez votre catégorie',
                                    icon: Icon(
                            ...
                            onPressed: () async {
                              if (valueOrDefault(
                                ...
                                context.pushNamed(TbdpresseWidget.routeName);
                                  ...
                                  'recruteur') {
                                context
                                    .pushNamed(RecruteurinfosWidget.routeName);
                              } else if (valueOrDefault(
                                      currentUserDocument?.type, '') ==
                                  'joueur') {
                                context.pushNamed(
                                    CompleteinfosjouereWidget.routeName);
                              } else if (valueOrDefault(
                                      currentUserDocument?.type, '') ==
                                  'equipe') {
                                context.pushNamed(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Dernière étape pour compléter votre inscription',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.readexPro(
