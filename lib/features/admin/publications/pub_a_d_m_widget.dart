    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            'Gestion des publications athèltes',
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<List<PublicationRecord>>(
                    stream: queryPublicationRecord(
                      queryBuilder: (publicationRecord) => publicationRecord
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<PublicationRecord> listViewPublicationRecordList =
                          snapshot.data!;
                      ...
                      return ListView.builder(
                        ...
                        itemCount: listViewPublicationRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewPublicationRecord =
                              listViewPublicationRecordList[listViewIndex];
                          return Container(
                            width: double.infinity,
                            decoration: BoxDecoration(
                              color: FlutterFlowTheme.of(context)
                              ...
                              child: Column(
                                ...
                                children: [
                                  FlutterFlowVideoPlayer(
                                    path: listViewPublicationRecord.postVido,
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  await listViewPublicationRecord
                                                      .reference
                                                      .delete();
                                                  ScaffoldMessenger.of(context)
                                                    ...
                                                    SnackBar(
                                                      content: Text(
                                                        'La publication a été suprimé avec succès',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                    ...
                                                    SnackBar(
                                                      content: Text(
                                                        'La publication a réussi la mention spécial Top',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .titleLarge
                      ...
                      children: [
                        ...
                        FlutterFlowDropDown<String>(
                          controller: _model.dropDownValueController2 ??=
                              FormFieldController<String>(null),
                          options: const ['Cette semaine', 'Ce mois', 'Cette année'],
                          onChanged: (val) =>
