...
/// SUR BASE DE CETTE APPLICATION CEE LA PAGE OU L'ADMINISTRATEURS PEUT
/// MODERER DES PUBLICATION  VIDO DES ATHLETES SIGNALER ET AUTRES LA PAGE DOIT
/// ETRE MODERNE
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: 'Rechercher des signalements...',
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      StreamBuilder<List<ModerationRecord>>(
                        stream: queryModerationRecord(
                          queryBuilder: (moderationRecord) => moderationRecord
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ModerationRecord> listViewModerationRecordList =
                              snapshot.data!;
                          ...
                          return ListView.builder(
                            ...
                            itemCount: listViewModerationRecordList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewModerationRecord =
                                  listViewModerationRecordList[listViewIndex];
                              return Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    16.0, 12.0, 16.0, 12.0),
                                child: Container(
